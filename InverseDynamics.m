...
f0 = uLINK(j).m * (uLINK(j).dvo + cross(uLINK(j).dw,c))   + cross(uLINK(j).w,P); %NE Force
t0 = uLINK(j).m * cross(c,uLINK(j).dvo) + I * uLINK(j).dw + cross(uLINK(j).vo,P) + cross(uLINK(j).w,L); %NE Moment
